...
let TasksController = class TasksController {
    ...
    toggleComplete(user, id) {
        return this.tasksService.toggleComplete(id, user.id);
    }
    partialUpdate(user, id, updateTaskDto) {
        return this.tasksService.update(id, user.id, updateTaskDto);
    }
    remove(user, id) {
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Task ID (UUID)' }),
...
__decorate([
    (0, common_1.Put)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Update a task completely' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Task ID (UUID)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Task ID (UUID)' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Task completion toggled' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Task not found' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id')),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Update a task partially' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Task ID (UUID)' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Task updated successfully' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Task not found' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }),
